        ...
        <div className={styles.courseBlock}>
          <div className={styles.courseSection}>
            ...
            <ul className={styles.courseList}>
              <li>Ви "вічно худнете", але не худнете</li>
              <li>Не можете зупинитися в їжі</li>
              <li>Заїдаєте емоції</li>
              <li>Відчуваєте втрату контролю</li>
              <li>Хочете перестати жити в постійній боротьбі з собою</li>
            </ul>
          </div>
          ...
          <div className={styles.courseSection}>
            ...
            <ul className={styles.courseList}>
              <li>Зрозумієте, чому це з вами відбувається</li>
              <li>Перестанете звинувачувати себе</li>
              <li>Побачите, де запускається переїдання</li>
              <li>Отримаєте перші інструменти змін</li>
            </ul>
          </div>
        </div>
        <div className={styles.heroCta}>
